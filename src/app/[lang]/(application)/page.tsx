...
export default async function Home(props: {
  ...
  return (
    <section className='relative m-auto overflow-hidden pt-24'>
      <div className='absolute left-0 top-0 -z-10 hidden h-64 w-64 rounded-full bg-primary opacity-50 blur-[180px] md:block'></div>
      <div className='absolute -right-8 top-0 -z-10 mt-40 h-80 w-80 rounded-full bg-primary opacity-50 blur-[180px]'></div>
