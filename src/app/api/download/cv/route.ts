...
export async function GET() {
  ...
  const buffer = await readFile(path.join(process.cwd(), "public/assets/author/CV_Sami_Paananen.pdf"));
  ...
  headers.append("Content-Disposition", 'attachment; filename="CV_Sami_Paananen.pdf"');
